...

{
  ...
  bip32_bip44.ExtendedPrivateKey key = chain.forPath("m/44'/1237'/0'/0") as bip32_bip44.ExtendedPrivateKey;

  // Get the first child key.
  bip32_bip44.ExtendedPrivateKey? childKey = bip32_bip44.deriveExtendedPrivateChildKey(key,0);
  String hexChildKey = "";
